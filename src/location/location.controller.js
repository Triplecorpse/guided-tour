...
var LocationController = function () {
    var _classDecorators = [(0, common_1.Controller)("location")];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var LocationController = _classThis = /** @class */ (function () {
        function LocationController_1() {
        }
        return LocationController_1;
    }());
