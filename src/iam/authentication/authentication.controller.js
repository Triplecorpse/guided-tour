...
var AuthenticationController = function () {
    var _classDecorators = [(0, common_1.Controller)("authentication")];
    ...
    var AuthenticationController = _classThis = /** @class */ (function () {
        function AuthenticationController_1(authService) {
            this.authService = (__runInitializers(this, _instanceExtraInitializers), authService);
        }
        AuthenticationController_1.prototype.signUp = function (data) {
            return this.authService.signUp(data);
        };
        AuthenticationController_1.prototype.signIn = function (data) {
    ...
    (function () {
        ...
        _signUp_decorators = [(0, common_1.Post)("sign-up"), openapi.ApiResponse({ status: 201, type: Boolean })];
        _signIn_decorators = [(0, common_1.Post)("sign-in"), openapi.ApiResponse({ status: 201, type: Boolean })];
